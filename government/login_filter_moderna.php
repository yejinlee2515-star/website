<?php
    ...
    $sql = "SELECT * from administrator_pharmacist";
    $ret = mysqli_query($con, $sql);

    while($row = mysqli_fetch_array($ret)){
        if ($row['id']==$userID and $row['password']==$userPW){
            header('Location: moderna.php');
        }
    }
    ...
    /*echo "<!DOCTYPE HTML>\n";
        ...
        echo "\n";
        /*echo "								<!-- Logo -->\n";*/
        echo "									<h1><a href=\"\" id=\"logo\"><span style=\"color:#1a255c\">모더나</a></h1>\n";
        echo "\n";
        echo "\n";
        echo "							</div>\n";
        echo "						</div>\n";
        ...
        echo "                              <FORM ACTION=\"login_moderna.html\">\n";
