<?php
   ...
   $sql="UPDATE supply SET supplyDate='$supplyDate', vaccineType='$vaccineType', amount='$amount' WHERE supplyNumber='$supplyNumber'";
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php 
                         ...
                         echo "<br> <a href='vaccin1_5.php'> <--백신 조회 화면</a>";
                         ?>
                        </div>       
                    </div>
                </div>
