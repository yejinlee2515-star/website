<html>
						...
						<div class="row">
							<div class="col-6 col-6-medium col-12-small">
								...
								<!-- Feature #1 -->
									<section>
										<h2>▶생산된 백신 재고량 조회</h2>
										<a href = 'select_moderna.php'> -> 조회 바로가기 </a><br>
										
										<br>
										<h2>▶생산 예정 백신 정보조회</h2>
										<a href = 'select_planned_moderna.php'> -> 조회 바로가기 </a><br>
										
										<br>
										<h2>▶유효기간 조회 및 폐기</h2>
										<a href = 'waste_moderna.php'> -> 조회 바로가기 </a><br>
										
										<br>
										<h2>▶백신 생산 계획 등록</h2>
										<a href = 'product_plan_moderna.php'> -> 등록 바로가기 </a><br><br>
   ...
   function query_all($con2, $sql2){
    ...
    $first="SELECT COUNT(*) as cnt FROM vaccine WHERE registrationDate BETWEEN ('2021-11-01') AND ('2021-11-07') AND pharmacistName='모더나'";
    $sec="SELECT COUNT(*) as cnt FROM vaccine WHERE registrationDate BETWEEN ('2021-11-08') AND ('2021-11-14') AND pharmacistName='모더나'";
    $third="SELECT COUNT(*) as cnt FROM vaccine WHERE registrationDate BETWEEN ('2021-11-15') AND ('2021-11-21') AND pharmacistName='모더나'";
    $fourth="SELECT COUNT(*)  as cnt FROM vaccine WHERE registrationDate BETWEEN ('2021-11-22') AND ('2021-11-28') AND pharmacistName='모더나'";
	$fifth="SELECT COUNT(*)  as cnt FROM vaccine WHERE registrationDate BETWEEN ('2021-11-29') AND ('2021-11-30') AND pharmacistName='모더나'";
