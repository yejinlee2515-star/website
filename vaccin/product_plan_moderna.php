...
<html>
            ...
            <section id="content">
                <div class="container">
                    <div class="row">
						...
						pharmacistName: <INPUT TYPE="text" NAME="pharmacistName" VALUE=<?php echo "모더나" ?> > <br>
 ...
 <?php
   ...
   if(isset($_GET["uniqueNumber"])==FALSE)
    ...
    $sql = "INSERT INTO vaccine VALUES('".$uniqueNumber."', '".$price."', '모더나', '".$registrationDate."', '".$validity."', '".$plannedProduction."', '".$plannedProduction."', '모더나')";
   
    $ret = mysqli_query($con, $sql);
                            
    if($ret){
         echo "success enrolling / ";
		 echo "<a href='moderna.php'><--돌아가기</a>";
    }
    else{
         echo "failed!!"."<br>";
