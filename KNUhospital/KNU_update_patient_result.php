<?php
   ...
   $covidConfirmation = $_POST["covidConfirmation"];  
   ...
   $sql12 = "UPDATE patient SET covidConfirmation='$covidConfirmation' WHERE pssn='".$_POST['pssn']."'";
...
<?php
 ...
 echo "<h1>환자 정보 수정 결과</h1>";
   ...
   echo "<br> <a href='KNUhospital1_2.php'> <--되돌아가기</a>";
  ?>
