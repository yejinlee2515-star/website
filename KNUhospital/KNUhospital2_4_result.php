...
<?php
   ...
   $sql="INSERT INTO supply values ('$count', '$supplyDate', '$vaccineType', '$amount', '경북대병원', '대한민국', '요청')";
   
   $count += 10000;
   $timestamp = strtotime("+2 days");
   $date2=date("Y-m-d", $timestamp);
   $sql2="INSERT INTO supply values ('$count', '$date2', '$vaccineType', '$amount', '경북대병원', '대한민국', '공급')";
   ...
   echo "<br><a href=\"KNUhospital2_4.php\"> 조회 화면</a><br>\n";  
   mysqli_close($con);
