               ...
               <div class="container">
                  <div class="row">
                     <div class="col-12">
                        ...
                        <!-- Logo -->
                           <h1><a href="KNUhospital.php" id="logo"><span style="color:#ffffff">KNU Medical Center</a></h1>
            ...
            <section id="content">
                <div class="container">
                    <div class="row">
                        ...
                        <input type="VARCHAR" name="hospitalName" value="경북대병원" aria-label="Small" size="20" placeholder="목적지 검색" readonly>      
...
<?php
   ...
   if($bool1){
      if($bool2){
         if($bool3){
           $sql="SELECT * FROM supply WHERE hospitalName='".$_GET['hospitalName']."' AND vaccineType='".$_GET['vaccineType']."' AND supplyDate='".$_GET['supplyDate']."'";
         }
         else{
            $sql="SELECT * FROM supply WHERE hospitalName='".$_GET['hospitalName']."' AND vaccineType='".$_GET['vaccineType']."'";
         }
      }
      else{
         if($bool3){
            $sql="SELECT * FROM supply WHERE hospitalName='".$_GET['hospitalName']."' AND supplyDate='".$_GET['supplyDate']."'";
         }
         else{
            $sql="SELECT * FROM supply WHERE hospitalName='".$_GET['hospitalName']."'";
         }
      }
   }
   else{
      if($bool2){
         if($bool3){
            $sql="SELECT * FROM supply WHERE vaccineType='".$_GET['vaccineType']."' AND supplyDate='".$_GET['supplyDate']."'";
         }
         else{
            $sql="SELECT * FROM supply WHERE vaccineType='".$_GET['vaccineType']."'";
         }
      }
      else{
         if($bool3){
            $sql="SELECT * FROM supply WHERE supplyDate='".$_GET['supplyDate']."'";
         }
         else{
   ...
   echo "<br> <a href='KNUhospital2_3.php'><--초기 화면</a>";
   mysqli_close($con);
   echo "</TABLE>";
?>                
