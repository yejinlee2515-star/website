<?php
    ...
    $sql_vaccine = "SELECT * from supply where hospitalName='경북대병원'and type='공급'";
    ...
    $sql_vaccine2 = "SELECT * from reservation where hname='경북대병원'";
   ...
   $ava_nor_count=0;
   $nor_count=0;
  $pssn = "SELECT * from patient where (hospitalizationDate!='0000-00-00' and dateOfDeath='0000-00-00' and hospitalName='경북대병원')";
  $pssn1 = "SELECT availableEmerBed, availableNorBed from hospital where hName='경북대병원'";
...
echo "      </style>\n";
        ...
        echo "\n";
        echo "                        <!-- Logo -->\n";
        echo "                           <h1><a href=\"KNUhospital.php\" id=\"logo\"><span style=\"color:#ffffff\">KNU Medical Center</a></h1>\n";
        echo "\n";
        echo "                        <!-- Nav -->\n";
        echo "                           <nav id=\"nav\">                              \n";
        ...
        echo "                              <h2>환자 정보 관련</h2>\n";
        echo "                              <p>\n";
        echo "                                            <a href=\"KNUhospital1_1.php\"> 1. 환자 정보 등록</a><br>\n";
        echo "                                            <a href=\"KNUhospital1_2.php\"> 2. 환자 정보 조회 및 수정</a><br>\n";   
	    echo "                                            <a href=\"KNUhospital1_3.php\"> 3. 접종 등록</a><br>\n";  	
		echo "  										  <a href=\"KNUhospital1_4.php\"> 4. 접종 계획 조회 및 수정</a><br>\n";  
        ...
        echo "                              <h2>백신 정보 관련</h2>\n";
        echo "                              <p>\n";
        #echo "                                 <a href=\"KNUhospital2_1.php\"> 1. 백신 재고 조회</a><br>\n";
...
echo "<TD>", $pfizer, "</TD>";
  ...
  echo"</TR>";
    echo"</table>";
        echo "                                 <a href=\"KNUhospital2_3.php\"> 1. 백신 공급일 조회</a><br>\n";       
		echo " 								   <a href=\"KNUhospital2_4.php\"> 2. 백신 요청 등록</a><br>\n"; 
		echo "                                 <a href=\"KNUhospital2_5.php\"> 3. 백신 요청 조회 및 수정</a><br>\n"; 
        echo "                              </p>\n";
        echo "                           </section>\n";
        echo "\n";
        echo "                     </div>\n";
        ...
        echo "                              <h2>병상 정보 관련</h2>\n";
        echo "                              <p> \n";
        #echo "                                 <a href=\"KNUhospital3_1.php\"> 1. 가용 병상 수 조회</a><br>\n";
  ...
  while($row=mysqli_fetch_array($data)){
   ...
   echo"<table class='bluetop'>";
   echo"<TR>";
   echo"<TH> 경북대병원 </TH><TH>보유 병상</TH><TH>가용 병상</TH>";
  echo"</TR>";
  echo"<TR>";
  echo"<TR>";
echo"<TR>";
