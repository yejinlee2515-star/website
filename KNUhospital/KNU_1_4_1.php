...
<?php
   ...
   $sql = "SELECT reservation.*, nation.name FROM reservation inner join nation WHERE (nation.ssn=reservation.ssn AND reservation.hname='경북대병원' AND nation.ssn='".$_GET["ssn"]."')";  
   ...
   if($ret){
      ...
      if($count==0){
         ...
         echo "<br> <a href='KNUhospital1_4.php'> <--초기화면</a>";
         exit();
      }
   }
   else{
...
?>
<h1> ▶접종 등록 </h1>
<FORM METHOD="post"  ACTION="KNU_1_4_1_result.php">
   ...
   병원명 : <INPUT TYPE ="text" value="경북대병원" readonly> <br>
   <BR><BR>
