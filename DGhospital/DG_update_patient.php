               ...
               <div class="container">
                  <div class="row">
                     <div class="col-12">
                        ...
                        <!-- Logo -->
                           <h1><a href="DGhospital.php" id="logo"><span style="color:#ffffff">DG Hospital</a></h1>
...
<?php
   ...
   if($ret){
      ...
      if($count==0){
         ...
         echo "<br> <a href='DGhospital.php'> <--초기화면</a>";
         exit();
      }
   }
   else{
...
<h1> 환자 등록 </h1>
<FORM METHOD="post"  ACTION="DG_update_patient_result.php">
    ...
    <label>
	입원일 : <INPUT TYPE ="date" NAME="hospitalizationDate" VALUE=<?php echo $hospitalizationDate ?>><br>
	</label>
	<label>
	퇴원일 : <INPUT TYPE ="date" NAME="dischargeDate" VALUE=<?php echo $dischargeDate ?>> <br>
	<label>
	사망일 : <INPUT TYPE ="date" NAME="dateOfDeath" VALUE=<?php echo $dateOfDeath ?>> <br>
	</label>
	<label>
	확진날짜 : <INPUT TYPE ="date" NAME="covidInspectionDate" VALUE=<?php echo $covidInspectionDate ?>> <br>
	</label>
