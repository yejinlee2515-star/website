...
<?php
   ...
   $sql = "SELECT reservation.*, nation.name FROM reservation inner join nation WHERE (nation.ssn=reservation.ssn AND reservation.hname='대구병원')";
   ...
   while($row=mysqli_fetch_array($ret)){
      ...
      echo "<TD>", $row['degree'], "</TD>";
        ...
        echo "<TD>", "<a href='DG_1_4_1.php?ssn=", $row['ssn'], "'>수정</a></TD>";
        echo "<TD>", "<a href='DG_1_4_2.php?ssn=", $row['ssn'], "'>삭제</a></TD?"; 
        echo "</TR>";
   }
   ...
   mysqli_close($con);
   echo "</TABLE>";
   echo "<br> <a href='DGhospital1_4.php'><--초기 화면</a>";
?>                
